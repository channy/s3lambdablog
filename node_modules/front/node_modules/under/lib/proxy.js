...
exports.send = function(req, res) {
  ...
  var proxyRequest = http.request(request_opts);
  ...
  */
  ...
  proxyRequest.on('response', function(proxyResponse) {
    ...
    var headers = proxyResponse.headers; // node returns them in lowercase form
    if (backend_name)
    ...
    /*
    emit('proxyResponse', proxyResponse);

    // Allow us to listen when the proxy has completed
    proxyRes.on('end', function () {
      emit('end', req, res, proxyResponse);
    })
    */
  ...
  // req.on('error', proxyError); // this should be handled by the parent server
